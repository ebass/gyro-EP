...
!!  EXPRO_ctrl_alpha_profiles_flag (0=default,1=use profiles from Alpha module) [deprecated]
!
!  * Derived quantities:
!
...
module EXPRO_interface
  ...
  real, dimension(:,:),allocatable :: EXPRO_energy_c
  ...
  real, dimension(5) :: EXPRO_ctrl_nscal
  real, dimension(5) :: EXPRO_ctrl_tscal
...
!  integer :: EXPRO_ctrl_alpha_profiles_flag = 0
