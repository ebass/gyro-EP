...
subroutine gyro_profile_init
  ...
  if (debug_flag == 1) call send_line('After gyro_radial_simulation_box.')
  !---------------------------------------------------
  ...
  if (debug_flag == 1) call send_line('gyro_profile_init checkpoint 1')
!  STOP   ! EMB 1.19.2021
  ...
  case (3) 
     ...
     !---------------------------------------------------------------
     if (debug_flag == 1) call send_line('After read_experimental_profiles (gyro_profile_init checkpoint 1.1)')
     call gyro_map_experimental_profiles
     if (debug_flag == 1) call send_line('After gyro_map_experimental_profiles (gyro_profile_init checkpoint 1.2)')
  ...
  if (debug_flag == 1) call send_line('After profile method selection (gyro_profile_init checkpoint 1.3)')
  ...
  !------------------------------------------------------------------
  if (debug_flag == 1) call send_line('gyro_profile_init checkpoint 2.')
!  STOP   ! EMB 1.19.2021
  !-------------------------------------------------------------
  ...
  alpha_s(:,:) = den_s(:,:)/tem_s(:,:)
  !------------------------------------------------------
  if (debug_flag == 1) call send_line('gyro_profile_init checkpoint 3.')
  !------------------------------------------------------
  ...
  !------------------------------------------------------
  if (debug_flag == 1) call send_line('gyro_profile_init checkpoint 4.')
  !----------------------------------------------------------
  ...
  !
  if (debug_flag == 1) call send_line('gyro_profile_init checkpoint 5.')
!  STOP  ! EMB 1.19.2021
  if (radial_profile_method == 3) then
  ...
  if (debug_flag == 1) call send_line('gyro_profile_init checkpoint 6.')
!  STOP   ! EMB 1.19.2021
  ...
  if (debug_flag == 1) call send_line('[gyro_profile_init done')
