subroutine gyro_init_ompdata()
  ...
  implicit none
!  integer, external :: omp_get_max_threads, omp_get_thread_num  ! OMP 1.19.2021

!  n_omp = omp_get_max_threads()               ! OMP 1.19.2021
  n_omp = 1     ! OMP 1.19.2021
!$omp parallel 
!  i_omp = omp_get_thread_num()   ! OMP 1.19.2021
